...
class phpVimeo {
   ...
   *
   * @param array 
   * $params The parameters for the response.
   * @param string
   *  $response The serialized response data.
   */
   ...
   *
   * @param array
   *  $oauth_params The OAuth parameters for the call.
   * @return string
   ...
   *
   * @param array $args 
   *    The full list of args to generate the signature for.
   ...
   *
   * @param array $params 
   *  The full list of api parameters for the request.
   */
   ...
   * @param array
   *  $call_params The parameters to pass to the method.
   * @param string
   *  $request_method The HTTP request method to use.
   * @param string
   *  $url The base URL to use.
   * @param boolean
   *  $cache Whether or not to cache the response.
   * @param boolean
   *  $use_auth_header Use the OAuth Authorization header to pass the OAuth params.
   * @return string
  ...
  * http://www.vimeo.com/api/docs/oauth
   *
   * @param string
   *  $perms The level of permissions to request: read, write, or delete.
   */
   ...
   *
   * @param string
   *  $type The type of cache to use (phpVimeo::CACHE_FILE is built in)
   * @param string
   *  $path The path to the cache (the directory for CACHE_FILE)
   * @param int
   *  $expire The amount of time to cache responses (default 10 minutes)
   */
   ...
   *
   * @param string
   *  $verifier The OAuth verifier returned from the authorization page or the user.
   */
   ...
   * @param string
   *  $permission The level of permissions to request: read, write, or delete.
   * @param string
   *  $callback_url The URL to redirect the user back to, or oob for the default.
   * @return string
   ...
   *
   * @return array
   *  An array with the token and token secret.
   */
   ...
   * @param string
   *  $type The type of token, either request or access
   * @param boolean
   *  $session_store Store the token in a session variable
    * @return boolean
   *  TRUE
   */
   ...
   * @param boolean
   *  $use_multiple_chunks Whether or not to split the file up into smaller chunks
   * @param string
   *  $chunk_temp_dir The directory to store the chunks in
   * @param int
   *  $size The size of each chunk in bytes (defaults to 2MB)
   * @return int
   *  The video ID
   */
   ...
   *
   * @param array/string
   *  $input A parameter or set of parameters to encode.
   */
...
class vimeo_field_VimeoAPIException extends Exception {
